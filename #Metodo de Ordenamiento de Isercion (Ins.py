#Metodo de Ordenamiento de Isercion (InsertionSort)
from random import sample 
lista = list(range(100))
vectorins = sample(lista,8)

def insertionsort(vectorins):
    """Esta funcion ordenara el vector que le pases como argumento con 
    ...
    print("El vector ordenado con insercion es: ", vectorins)
